...
// //       try {
// //         const response = await axios.get("https://mrityunjay6294.pythonanywhere.com/portfolio/profiles/1/");
...
//
//   useEffect(() => {
//     if (data.profile_data && data.profile_data.job_title) {
//       const interval = setInterval(() => {
//         setJobIndex((prevIndex) => (prevIndex + 1) % data.profile_data.job_title.split(" / ").length);
//       }, 2000); // Change slide every 2 seconds
//
//       return () => clearInterval(interval);
//     }
...
//   }
//
//   const { first_name, last_name, job_title, about_me } = data.profile_data;
//
//   const getJobTitleClass = (index) => {
//     switch (index) {
//       case 0:
